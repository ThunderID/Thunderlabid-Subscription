...
class PublishingAtLeastHaveOneFeature
{
    /**
    ...
    {
        if (isset($event->attr->published_at) && $event->data->features->count() < 1)
        {
            throw ValidationException::withMessages(['features' => 'min:1']);
        }
    }
}
